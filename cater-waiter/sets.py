...
def compile_ingredients(dishes):
    ...
    result = {ingredient for dish in dishes for ingredient in dish}
    return result
...
def singleton_ingredients(dishes, intersection):
    ...
    intersection_ingredients = set(intersection)
    return all_ingredients.difference(intersection_ingredients)